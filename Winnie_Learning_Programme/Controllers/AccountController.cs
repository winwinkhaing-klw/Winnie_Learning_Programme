...
namespace Winnie_Learning_Programme.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
        {
            ...
            pwdHasher = new Services.PasswordHasher(new WKDbEntities());
        }
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string encryptedPassword = pwdHasher.EncryptPassword(model.Password);
                user.Password = encryptedPassword;
                user.Address = model.Address;
                int userId = userServices.Register(user);
            ...
            ViewBag.message = "Your registration is fail.";
            return View(model);
        }
